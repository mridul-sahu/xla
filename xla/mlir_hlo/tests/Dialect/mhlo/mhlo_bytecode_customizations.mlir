...
func.func @test_bytecode_customizations(
  ...
  orig_val_el = #mhlo.original_value_element<[0], #mhlo.original_array<"source_op", []>>,
  orig_val = #mhlo.original_value<false, [#mhlo.original_value_element<[0], #mhlo.original_array<"first_instruction", [0, 1]>>, #mhlo.original_value_element<[1], #mhlo.original_array<"second_instruction", [2]>>]>
} {
  func.return
}
