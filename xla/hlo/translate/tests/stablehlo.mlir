...
module {
  func.func @main() -> tensor<i32> {
    %0 = stablehlo.constant {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[], #mhlo.original_array<"constant.5", []>>]>} dense<0> : tensor<i32>
    return %0 : tensor<i32>
  }
}
...
module {
  func.func @main(%arg0: tensor<192xf32>) -> tensor<1x17x17x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg0, dims = [3] {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[], #mhlo.original_array<"broadcast.2342", []>>]>} : (tensor<192xf32>) -> tensor<1x17x17x192xf32>
