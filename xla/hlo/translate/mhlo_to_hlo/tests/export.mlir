...
module {
  func.func @main(%arg0: tensor<192xf32> {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[], #mhlo.original_array<"a", []>>]>}) -> tensor<192xf32> {
...
module {
  func.func @main() -> tensor<i32> {
    %0 = mhlo.constant {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[], #mhlo.original_array<"constant.5", []>>]>} dense<0> : tensor<i32>
    return %0 : tensor<i32>
  }
}
...
func.func @main(%arg0: tensor<192xf32>) -> tensor<1x17x17x192xf32> {
  %0 = "mhlo.broadcast_in_dim"(%arg0) <{broadcast_dimensions = dense<3> : tensor<1xi64>}> {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[], #mhlo.original_array<"broadcast.2342", []>>]>} : (tensor<192xf32>) -> tensor<1x17x17x192xf32>
...
func.func @main(%arg0: tensor<10xf32>) -> tensor<8xf32> {
  %0:2 = mhlo.topk(%arg0, k=8, largest=true) {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[0], #mhlo.original_array<"t", [0]>>, #mhlo.original_value_element<[1], #mhlo.original_array<"t", [1]>>]>} : tensor<10xf32> -> (tensor<8xf32>, tensor<8xi32>)
...
func.func @main(%arg0: tensor<i32> {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[], #mhlo.original_array<"a", []>>]>}, %arg1: tensor<i32> {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[], #mhlo.original_array<"b", []>>]>}) -> (tensor<i32>) {
  %c = stablehlo.constant {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[], #mhlo.original_array<"c", []>>]>} dense<0> : tensor<i32>
  %0:2 = stablehlo.while(%iterArg = %c, %iterArg_0 = %arg0) : tensor<i32>, tensor<i32> attributes {mhlo.original_value = #mhlo.original_value<false, [#mhlo.original_value_element<[0], #mhlo.original_array<"while", [0]>>, #mhlo.original_value_element<[1], #mhlo.original_array<"while", [1]>>, #mhlo.original_value_element<[2], #mhlo.original_array<"while", [2]>>]>}
  cond {
